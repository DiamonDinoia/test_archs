...
#ifndef PDQSORT_MARCO_H
#define PDQSORT_MARCO_H
...
namespace pdqsort_marco_detail {
    enum {
...
template<class Iter, class Compare>
inline void pdqsort_marco(Iter begin, Iter end, Compare comp) {
    if (begin == end) return;
...
template<class Iter>
inline void pdqsort_marco(Iter begin, Iter end) {
    typedef typename std::iterator_traits<Iter>::value_type T;
    pdqsort(begin, end, std::less<T>());
}

template<class Iter, class Compare>
inline void pdqsort_marco_branchless(Iter begin, Iter end, Compare comp) {
    if (begin == end) return;
...
template<class Iter>
inline void pdqsort_marco_branchless(Iter begin, Iter end) {
    typedef typename std::iterator_traits<Iter>::value_type T;
