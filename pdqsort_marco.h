...
namespace pdqsort_detail {
    enum {
        // Partitions below this size are sorted using insertion sort.
                insertion_sort_threshold = 16384,
    ...
    inline void pdqsort_loop(Iter begin, Iter end, Compare comp, int bad_allowed, bool leftmost = true) {
        ...
        while (true) {
            ...
            if (highly_unbalanced) {
                ...
                if (l_size >= insertion_sort_threshold/sizeof(typename std::iterator_traits<Iter>::value_type)) {
                ...
                if (r_size >= insertion_sort_threshold/sizeof(typename  std::iterator_traits<Iter>::value_type)) {
